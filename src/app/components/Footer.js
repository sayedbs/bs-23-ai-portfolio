...
const Footer = () => {
  return (
    <footer className="bg-[#02215c] text-white py-6">
      <div className="container mx-auto px-6 grid grid-cols-12 gap-6 items-center">

        {/* Center Section: Certifications */}
        <div className="col-span-12 md:col-span-8 md:mt-0">
          <h4 className="font-semibold text-[#00a0dc] text-2xl mb-2">Certifications:</h4>
        ...
        <div className="col-span-12 md:col-span-4 md:mt-0">
          <h4 className="font-semibold text-[#00a0dc] text-2xl mb-2">Solutions Partners:</h4>
