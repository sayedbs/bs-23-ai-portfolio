...
const Footer = () => {
    return (
        <footer className="bg-[#02215c] text-white pb-6 pt-14">
            <div className="container mx-auto px-6 grid grid-cols-12 gap-6">
                <div className="col-span-12 md:col-span-8 md:mt-0">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <div className="bg-white border-2 border-gray-800 rounded">
                            <Image
                                src="/images/partner/atlassian.png"
                                alt="atlassian"
                                width={140}
                                height={72}
                            />
                        ...
                        <div className="bg-white border-2 border-gray-800 rounded">
                            <Image
                                src="/images/partner/google_cloud.png"
                                alt="google_cloud"
                                width={140}
                                height={72}
                            />
                        ...
                        <div className="bg-white border-2 border-gray-800 rounded">
                            <Image
                                src="/images/partner/microsoft.png"
                                alt="microsoft"
                                width={140}
                                height={72}
                            />
                        ...
                        <div className="bg-white border-2 border-gray-800 rounded">
                            <Image
                                src="/images/partner/nopCommerce.png"
                                alt="nopCommerce"
                                width={140}
                                height={72}
                            />
                        ...
                        <div className="bg-white border-2 border-gray-800 rounded">
                            <Image
                                src="/images/partner/saleforce.png"
                                alt="saleforce"
                                width={140}
                                height={72}
                            />
                ...
                <div className="col-span-12 md:col-span-4 md:mt-0">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Image
                            ...
                            src="/images/cirtification/iso9001.png"
                            alt="iso9001"
                            width={336}
                            height={98}
                        />
            ...
            <div className=" text-gray-100 py-4 pt-8 text-center px-3 text-xl">
                ...
                <a
                    ...
                    target="__blank"
                    className="underline hover:text-white text-[#bdedff]"
                >
                    Brainstation 23
                </a>{" "}
                All rights reserved.
