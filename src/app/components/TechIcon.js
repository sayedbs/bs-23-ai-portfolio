...
const techIcons = {
    ...
    "Analytics & Monitoring: Firebase Analytics, Crashlytics": (
        <IoLogoFirebase style={{ color: "#DD2C00" }} />
    ),
    ...
    "Google Big Query": (
        <MdOutlineScreenSearchDesktop style={{ color: "#4285F4" }} />
    ),
    "Google Search API": (
        <MdOutlineScreenSearchDesktop style={{ color: "#4285F4" }} />
    ),
    ...
    Azure: (
        <span className="flex" style={{ color: "#159D7E" }}>
            <VscAzure />
        </span>
    ),
    "Azure OpenAI": (
        <span className="flex" style={{ color: "#159D7E" }}>
            <VscAzure /> <AiFillOpenAI />
        </span>
    ),
    ...
    "Analytics & Monitoring: Firebase Analytics": (
        <RiFirebaseFill style={{ color: "#FFCA28" }} />
    ),
...
const TechIcon = ({ iconName, className = "" }) => {
    return (
        (
            <span
                className={`flex items-center gap-1 text-xl transform scale-110 transition-all ${className}`}
            >
                {techIcons[iconName]}
            </span>
        ) || ""
